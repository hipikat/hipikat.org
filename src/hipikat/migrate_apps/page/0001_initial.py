...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'page_page', (
            ...
            ('publication_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 11, 16, 0, 0))),
            ...
            ('symlinked_page', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'page_page_symlinks', null=True, to=orm['page.Page'])),
            ...
            ('template_key', self.gf('django.db.models.fields.CharField')(default='layouts/standard.html', max_length=255)),
        ))
        db.send_create_signal(u'page', ['Page'])

        # Adding M2M table for field related_pages on 'Page'
        m2m_table_name = db.shorten_name(u'page_page_related_pages')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_page', models.ForeignKey(orm[u'page.page'], null=False)),
            ('to_page', models.ForeignKey(orm[u'page.page'], null=False))
        ))
        db.create_unique(m2m_table_name, ['from_page_id', 'to_page_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'page_page_related_pages'))
