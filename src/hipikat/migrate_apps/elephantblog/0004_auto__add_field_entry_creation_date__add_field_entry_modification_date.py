...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.creation_date'
        db.add_column(u'elephantblog_entry', 'creation_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Entry.modification_date'
        db.add_column(u'elephantblog_entry', 'modification_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry.creation_date'
        db.delete_column(u'elephantblog_entry', 'creation_date')

        # Deleting field 'Entry.modification_date'
        db.delete_column(u'elephantblog_entry', 'modification_date')
    ...
    models = {
        ...
        u'page.page': {
            ...
            'publication_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 17, 0, 0)'}),
